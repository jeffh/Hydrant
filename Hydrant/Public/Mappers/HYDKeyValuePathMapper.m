...
HYD_EXTERN
HYD_OVERLOADED
HYDKeyValuePathMapper *HYDMapObjectPath(NSString *destinationKey, Class destinationClass, NSDictionary *mapping)
{
    return HYDMapObjectPath(destinationKey, [NSDictionary class], destinationClass, mapping);
}
