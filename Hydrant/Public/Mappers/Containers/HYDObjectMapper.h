 ...
 */
HYD_EXTERN_OVERLOADED
id<HYDMapper> HYDMapKVCObject(NSString *destinationKey, Class sourceClass, Class destinationClass, NSDictionary *mapping)
HYD_REQUIRE_NON_NIL(2,3,4);
 ...
 */
HYD_EXTERN_OVERLOADED
id<HYDMapper> HYDMapKVCObject(NSString *destinationKey, Class destinationClass, NSDictionary *mapping)
HYD_REQUIRE_NON_NIL(2,3);
