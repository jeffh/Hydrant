...
public:
    ...
    bool matches(const JOMError *) const;
...
protected:
    ...
    bool domain_matches(const JOMError *error) const;
    bool code_matches(const JOMError *error) const;
    bool fatality_matches(const JOMError *error) const;
    bool subset_of_userinfo_matches(const JOMError *error) const;
