...
SPEC_BEGIN(JOMStringToDateMapperSpec)

describe(@"JOMStringToDateMapper", ^{
    __block JOMStringToDateMapper *mapper;
    ...
    beforeEach(^{
        ...
        mapper = JOMStringToDate(@"destinationKey", @"yyyy-MM-dd 'at' HH:mm:ss");
    });
