...
SPEC_BEGIN(JOMDateToStringMapperSpec)

describe(@"JOMDateToStringMapper", ^{
    __block JOMDateToStringMapper *mapper;
    __block NSDate *date;
    ...
    beforeEach(^{
        ...
        mapper = JOMDateToString(@"dateKey", @"yyyy-MM-dd 'at' HH:mm:ss");
    });
    ...
    describe(@"reverse mapper", ^{
        __block JOMStringToDateMapper *reverseMapper;
        beforeEach(^{
