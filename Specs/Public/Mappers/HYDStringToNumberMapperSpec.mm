...
describe(@"HYDStringToNumberMapper", ^{
    __block HYDStringToNumberMapper *mapper;
    ...
    beforeEach(^{
        ...
        mapper = HYDStringToNumberByFormat(@"destKey", NSNumberFormatterDecimalStyle);
    });
    ...
    describe(@"reverse mapper", ^{
        __block HYDNumberToStringMapper *reverseMapper;
