...
SPEC_BEGIN(JOMDotNetDateFormatterSpec)

describe(@"JOMDotNetDateFormatter", ^{
    __block JOMDotNetDateFormatter *formatter;
    __block id sourceObject;
    __block id parsedObject;

    beforeEach(^{
        formatter = [[JOMDotNetDateFormatter alloc] init];
    });
